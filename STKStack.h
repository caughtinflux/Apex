...
@property (nonatomic, readonly) STKIconLayout *appearingIconLayout;
@property (nonatomic, readonly) STKIconLayout *iconViewLayout;
@property (nonatomic, readonly) STKIconLayout *displacedIconLayout;
